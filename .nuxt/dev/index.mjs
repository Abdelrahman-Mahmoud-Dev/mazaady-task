...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/devalue/index.js';
import { renderToString } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/ofetch/dist/node.mjs';
import destr from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/scule/dist/index.mjs';
import { klona } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/mazaady--task/nuxt-tailwind-pinia/node_modules/radix3/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "privateKey": "3%o8i}_;3D4bF]G5@22r2)Et1&mLJ4?$@+16",
...
const serverAssets = [{"baseName":"server","dir":"E:/mazaady--task/nuxt-tailwind-pinia/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\mazaady--task\\nuxt-tailwind-pinia","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\mazaady--task\\nuxt-tailwind-pinia\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\mazaady--task\\nuxt-tailwind-pinia\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\mazaady--task\\nuxt-tailwind-pinia\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"E:\\mazaady--task\\nuxt-tailwind-pinia\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_nc6zYr = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_nc6zYr, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nc6zYr, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://E:/mazaady--task/nuxt-tailwind-pinia/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://E:/mazaady--task/nuxt-tailwind-pinia/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
